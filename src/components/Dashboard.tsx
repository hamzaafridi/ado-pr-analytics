  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">PR Analytics Dashboard</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Open PR Analytics</h2>
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <OpenPRUserPieChart userCounts={analytics.openPRAnalytics.userCounts} />
            <ReviewerPieChart reviewerMetrics={analytics.openPRAnalytics.reviewerMetrics} />
          </div>
          ...
          <div>
            <ReviewerMetricsTable reviewerMetrics={analytics.openPRAnalytics.reviewerMetrics} />
          </div>
